...
class TestMod(loader.Module):
        ...
        self.config = loader.ModuleConfig(
            loader.ConfigValue(
                ...
                (
                    ...
                    " Haruka will try to determine, which client caused logs. E.g. there"
                    ...
                    " Haruka will send all logs to Client1 and Client2, even if it is"
    ...
    @loader.loop(interval=5, wait_before=True, autostart=True)
    ...
    async def logs(
        ...
        other = (
            *main.__version__,
            (
                " <a"
                f' href="https://github.com/fuckramochka/haruka/commit/{ghash}">@{ghash[:8]}</a>'
                if ghash
                else ""
            ),
        )
    ...
    async def _post_start_client_ready(self):
        ...
        try:
            chat, _ = await utils.asset_channel(
                self._client,
                "haruka-logs",
                "🪐 Your Haruka logs will appear in this chat",
                silent=True,
                invite_bot=True,
                avatar="https://raw.githubusercontent.com/coddrago/assets/refs/heads/main/haruka/haruka_logs.png",
            )
            ...
            logger.exception("Tester post-start initialization failed")
