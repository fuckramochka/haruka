...
class CoreMod(loader.Module):
    ...
    @loader.command(ru_doc="Информация о Хероку", en_doc="Information of Haruka", ua_doc="Інформація про Хероку", de_doc="Informationen über Haruka")
    async def harukacmd(self, message: Message):
        await utils.answer(
            message,
            self.strings("haruka").format(
                (
                    utils.get_platform_emoji()
                    if self._client.haruka_me.premium and CUSTOM_EMOJIS
                    else "🪐 <b>Haruka userbot</b>"
                ),
                *version.__version__,
                utils.get_commit_url(),
                f"{harukatl.__version__} #{harukatl.tl.alltlobjects.LAYER}",
            )
            + (
                ""
            ...
            file= "https://raw.githubusercontent.com/coddrago/assets/refs/heads/main/haruka/haruka_cmd.png",
    ...
    async def installationcmd(self, message: Message):
        ...
        if (not args or args not in {'-vds', '-wsl', '-ul', '-jh', '-hh', '-lh'}) and \
            not (await self.inline.form(
                ...
                photo="https://raw.githubusercontent.com/coddrago/assets/refs/heads/main/haruka/haruka_installation.png",
            ...
            await self.client.send_file(
                message.peer_id,
                "https://raw.githubusercontent.com/coddrago/assets/refs/heads/main/haruka/haruka_installation.png",
