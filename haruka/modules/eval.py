...
import harukatl
from harukatl.errors.rpcerrorlist import MessageIdInvalidError
from harukatl.sessions import StringSession
...
class Evaluator(loader.Module):
    ...
    class _SecureDB:
        ...
        def set(self, *args, **kwargs):
            if len(args) >= 2 and args[0] == "haruka.security" and args[1] == "owner":
                raise ValueError(
    ...
    async def e(self, message: Message):
        ...
        try:
            ...
            item = HarukaException.from_exc_info(*sys.exc_info())
    ...
    def censor(self, ret: str) -> str:
        ret = ret.replace(str(self._client.haruka_me.phone), "&lt;phone&gt;")
        ...
        if btoken := self._db.get("haruka.inline", "bot_token", False):
            ret = ret.replace(
                btoken,
                f'{btoken.split(":")[0]}:{"*" * 26}',
            )
    ...
    async def getattrs(self, message: Message) -> dict:
        ...
        return {
            ...
            "self": self,
            "db": self.db,
            **self.get_sub(harukatl.tl.functions),
            **self.get_sub(harukatl.tl.types),
        }
