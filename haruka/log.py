...
from harukatl.errors.rpcbaseerrors import ServerError, RPCError
        ...
        def to_hashable(dictionary: dict) -> dict:
            ...
            for key, value in dictionary.items():
                match value:
                    ...
                    case harukatl.TelegramClient() | CustomTelegramClient():
    ...
    async def sender(self):
        async with self._send_lock:
            ...
            for client_id in self._mods:
                ...
                funcs = []
                for item in self.tg_buff:
                    if not isinstance(item[0], HarukaException):
                        continue
