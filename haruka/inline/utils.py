...
class Utils(InlineUnit):
    ...
    def _generate_markup(
        self: "InlineManager",
        markup_obj: typing.Optional[typing.Union[HarukaReplyMarkup, str]],
    ...
    def _normalize_markup(
        self: "InlineManager", reply_markup: HarukaReplyMarkup
    ...
    def _validate_markup(
        self: "InlineManager",
        buttons: typing.Optional[HarukaReplyMarkup],
    ) -> typing.List[typing.List[typing.Dict[str, typing.Any]]]:
        if buttons is None:
            buttons = []
