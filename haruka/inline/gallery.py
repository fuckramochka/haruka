...
from harukatl.errors.rpcerrorlist import ChatSendInlineForbiddenError
...
class Gallery(InlineUnit):
    async def gallery(
        ...
        *,
        custom_buttons: typing.Optional[HarukaReplyMarkup] = None,
        force_me: bool = False,
        ...
        :param gif: Whether the gallery will be filled with gifs. If you omit this argument and specify
                    gifs in `next_handler`, Haruka will try to determine the filetype of these images
