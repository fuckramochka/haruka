...
from harukatl.errors.rpcerrorlist import ChannelsTooMuchError
    ...
    async def init(self):
        ...
        try:
            self._assets, _ = await utils.asset_channel(
                ...
                archive=True,
                avatar="https://raw.githubusercontent.com/coddrago/assets/refs/heads/main/haruka/haruka_assets.png"
            )
    ...
    def read(self):
        ...
        try:
            ...
            if re.search(r'"(hikka\.)(\S+\":)', db):
                ...
                db = re.sub(r'(hikka\.)(\S+\":)', lambda m: 'haruka.' + m.group(2), db)
